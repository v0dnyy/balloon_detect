...
def set_attitude_blocking(
    connection, roll_angle=0.0, pitch_angle=0.0, yaw_angle=0, thrust=0.5, duration=0
):
    """
    Устанавливает положение дрона на определенное время
    """
    send_attitude_target(connection, roll_angle, pitch_angle, yaw_angle, thrust)
    start = time.time()
...
def send_attitude_target(
    connection, roll_angle=0.0, pitch_angle=0.0, yaw_angle=0.0, thrust=0.5
):
    """
